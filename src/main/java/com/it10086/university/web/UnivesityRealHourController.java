...
public class UnivesityRealHourController {
    @Resource
    private UnivesityRealHourService univesityRealHourService;
    ...
    public Result byArea(HttpServletRequest request) {
        ...
        List<Map<String, Object>> list = univesityRealHourService.byArea(statisDay,authCode);
    ...
    public Result byUniversity(HttpServletRequest request){
        ...
        Integer statisDay=Integer.parseInt(statisDay2);
        List<Map<String, Object>> list = univesityRealHourService.byUniversity(statisDay,areaCode);
        return ResultGenerator.genSuccessResult(list);
    }
    ...
    public Result bySingalUniversity(HttpServletRequest request){
        ...
        Integer statisDay=Integer.parseInt(statisDay2);
        List<Map<String, Object>> list = univesityRealHourService.bySingalUniversity(statisDay,universityCode);
        return ResultGenerator.genSuccessResult(list);
    }
}
