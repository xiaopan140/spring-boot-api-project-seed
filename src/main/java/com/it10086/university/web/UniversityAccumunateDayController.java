...
public class UniversityAccumunateDayController {
    @Resource
    private UniversityAccumunateDayService universityAccumunateDayService;
    ...
    public Result byArea(HttpServletRequest request){
        ...
        List<Map<String, Object>> list = universityAccumunateDayService.byArea(statisDay,isOpenData,authCode);
    ...
    public Result byUniversity(HttpServletRequest request){
        ...
        String isOpenData=jsonObject.get("isOpenData").toString();
        Integer statisDay=Integer.parseInt(statisDay2);
        List<Map<String, Object>> list = universityAccumunateDayService.byUniversity(statisDay,areaCode,isOpenData);
        return ResultGenerator.genSuccessResult(list);
    }
}
